            ...
            <div class="rounded-b-lg relative overflow-hidden h-screen">
              ...
              <div class="container mx-auto px-6 md:px-12 relative z-10 flex items-center py-32 xl:py-40">
                <div class="lg:w-3/5 xl:w-2/5 flex flex-col items-start relative z-10">
                  <span class="font-bold uppercase text-yellow-400">Alpinastra THEM</span>
                  <h1 class="font-bold text-6xl sm:text-7xl text-white leading-tight mt-4">Emportez vous dans<br/>mon portfolio</h1>
                  <a href="#" class="block bg-white hover:bg-gray-100 py-3 px-4 rounded-lg text-lg text-gray-800 font-bold uppercase mt-10">Découvrir</a>
                </div>
              </div>
            </div>
          </Parallax>
                  ...
                  <ul class="mt-8 md:grid md:grid-cols-2 gap-6">
                    <li class="mt-6 lg:mt-0">
                      <div class="flex">
                        ...
                        <span class="ml-4 text-base leading-6 font-medium text-gray-500 dark:text-gray-500">Novateur</span>
                      </div>
                    </li>
                    <li class="mt-6 lg:mt-0">
                      <div class="flex">
                        ...
                        <span class="ml-4 text-base leading-6 font-medium text-gray-500 dark:text-gray-500">Intégration / Gestion en équipe</span>
                      </div>
                    </li>
                    <li class="mt-6 lg:mt-0">
                      <div class="flex">
                        ...
                        <span class="ml-4 text-base leading-6 font-medium text-gray-500 dark:text-gray-500">Tête pensante</span>
                      </div>
                    </li>
                    <li class="mt-6 lg:mt-0">
                      <div class="flex">
                        ...
                        <span class="ml-4 text-base leading-6 font-medium text-gray-500 dark:text-gray-500">Perfectionniste</span>
                      </div>
                    </li>
                  </ul>
                </div>
        ...
        <footer class="bg-white dark:bg-gray-800 w-full py-8">
          <div class="max-w-screen-xl mx-auto px-4">
            <ul class="max-w-screen-md mx-auto text-lg font-light flex flex-wrap justify-between">
              <li class="my-2"><a class="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">FAQ</a></li>
              <li class="my-2"><a class="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">Configuration</a></li>
              <li class="my-2"><a class="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">Github</a></li>
              <li class="my-2"><a class="text-gray-400 hover:text-gray-800 dark:text-gray-300 dark:hover:text-white transition-colors duration-200" href="#">LinkedIn</a></li>
            </ul>
